...
public class Reminder2CalSync {
    ...
    public init(appConfig: AppConfig, completion: @escaping (Bool) -> Void) {
    ...
    private func fetchReminders(startDate: Date, endDate: Date, completion: @escaping ([EKReminder]) -> Void) {
